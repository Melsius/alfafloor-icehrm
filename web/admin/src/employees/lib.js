...
class EmployeeAdapter extends SubProfileEnabledAdapterBase {
  ...
  getFormFields() {
    ...
    const fields = [
      ...
      ['employee_id', { label: 'Employee Number', type: 'text', validation: 'none' }],
      ['first_name', { label: 'First Name', type: 'text', validation: 'none' }],
      ['middle_name', { label: 'Middle Name', type: 'text', validation: 'none' }],
      ['last_name', { label: 'Last Name', type: 'text', validation: 'none' }],
      ['nationality', { label: 'Nationality', type: 'select2', 'allow-null': true, 'remote-source': ['Nationality', 'id', 'name'] }],
      ['birthday', { label: 'Date of Birth', type: 'date', validation: 'dateOrEmpty' }],
      ['gender', { label: 'Gender', type: 'select', 'allow-null': true, source: [['Male', 'Male'], ['Female', 'Female']] }],
      ['marital_status', { label: 'Marital Status', type: 'select', 'allow-null': true, source: [['Married', 'Married'], ['Single', 'Single'], ['Divorced', 'Divorced'], ['Widowed', 'Widowed'], ['Other', 'Other']] }],
      ['ethnicity', {
      ...
      ['country', { label: 'Country', type: 'select2', 'allow-null': true, 'remote-source': ['Country', 'code', 'name'] }],
      ['province', {
      ...
      ['joined_date', { label: 'Joined Date', type: 'date', validation: 'dateOrEmpty' }],
